    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.mainContent}>
          <Text style={styles.title}>Update EV Info</Text>
      ...
      <View style={styles.buttonContainer}>
        <CustomButton title="Update" onPress={handleNext} type="primary" />
      </View>
    </View>
  );
};
