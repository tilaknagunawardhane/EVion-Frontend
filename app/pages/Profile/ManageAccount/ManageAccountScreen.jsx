...
const ManageAccountScreen = () => {
  ...
  const handleUpdate = (fieldKey) => {
    if (fieldKey === 'homeAddress') {
      router.push('/pages/Profile/ManageAccount/Address'); 
      return;
    }
      ...
      return (
        <View style={{ marginTop: 24 }}>
          <TouchableOpacity
            ...
            onPress={() => {
              console.log('Email button pressed - Current email:', fields.email);
              router.push('./UpdateEmailScreen?currentEmail=' + encodeURIComponent(fields.email));
            }}
          >
            <View>
